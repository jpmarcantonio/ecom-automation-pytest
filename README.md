...
This repo is to serve as a base to write and add more tests to practice QA Automation.
...
### Clone the code
```
git clone https://github.com/jpmarcantonio/ecom-automation-pytest.git
```

Navigate to the cloned directory
```
cd ecom-automation-pytest
```
...
```commandline
export PYTHONPATH=/<path>/<to>/ecom-automation-pytest
